plugins {
    ...
    id("kotlin-kapt") // this for Room annotation processing
}
...
dependencies {
    ...
    // Compose activity integration for setContent
    implementation("androidx.activity:activity-compose:1.7.2")

    implementation("androidx.compose.ui:ui-text") // required for KeyboardOptions
